...
TEST_CASE("get quantile value for 0.01, df = 6")
{
    FD_STAT_Util stat_util{};
    CHECK(stat_util.students_t_quantile(0.01, 6) == doctest::Approx(-3.14267));
}
TEST_CASE("get quantile value for 0.05, df = 8")
{
    FD_STAT_Util stat_util{};
    CHECK(stat_util.students_t_cdf(0.05, 8) == doctest::Approx(0.519326));
}
